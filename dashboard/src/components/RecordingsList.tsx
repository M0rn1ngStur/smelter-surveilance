  ...
  return (
    <main>
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="text-sm text-slate-400">{recordings.length} segment(s)</span>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-sentinel-border p-12 text-center">
          ...
          <p className="text-sm text-slate-500">No recorded segments</p>
          <p className="mt-1 text-xs text-slate-600">
            Segments with motion are analyzed automatically
          </p>
        </div>
      ) : (
